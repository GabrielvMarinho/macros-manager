...
class SAP:
    ...
    def __init__(self, window: int, scheduled_execution, language: str, section_parent_folder, parent_folder):
        ...
        self.idiom = language
        self.section_parent_folder = section_parent_folder 
    ...
    def select_transaction(self, transaction: str):
        ...
        if not self.session.info.transaction == transaction.upper():
