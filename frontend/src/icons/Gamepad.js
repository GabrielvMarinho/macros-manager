...
export default function (){
    ...
    return(
        <svg onMouseEnter={() =>setHover(true)} onMouseLeave={() =>setHover(false)} className="icon" fill={hover?"var(--color-primary)":"var(--text-dark)"} height="var(--icon-height)" width="var(--icon-width)" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 508 508">
        <g>
            <g>
